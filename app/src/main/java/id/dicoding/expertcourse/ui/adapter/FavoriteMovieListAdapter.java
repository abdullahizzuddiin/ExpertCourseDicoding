...
public class FavoriteMovieListAdapter extends RecyclerView.Adapter<FavoriteMovieListAdapter.ViewHolder> {
    private final List<FavoriteBaseMovie> movieList = new ArrayList<>();

    public void setData(List<FavoriteBaseMovie> baseMovieList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        FavoriteBaseMovie favoriteBaseMovie = movieList.get(position);
        String overview = favoriteBaseMovie.getOverview().isEmpty() ?
                holder.itemView.getContext().getResources().getString(R.string.no_overview_text) :
                favoriteBaseMovie.getOverview();
        holder.bind(favoriteBaseMovie, overview);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(FavoriteBaseMovie movie, String overview) {
            Picasso.get().
