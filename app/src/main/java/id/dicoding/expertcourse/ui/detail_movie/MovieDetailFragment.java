...
public class MovieDetailFragment extends Fragment implements MovieDetailContract.View {
    ...
    private TextView titleTv, releaseYearTv, reviewScoreTv, reviewScoreBasisTv, overviewTv, originalLanguageTv, runtimeTv, revenueTv, budgetTv;
    ...
    @Override
    public Movie getMovieExtra() throws NullPointerException {
